...
fprintf('Angle of twist per unit length: %6.2f rad/in \n',theta)
fprintf('                  Total torque: %6.2f k.in \n',T)
fprintf('  Numerical Torsional rigidity: %6.2f k.in^2/rad \n',T/theta)
fprintf('____________________________________________________ \n')
fprintf(' Analytical Torsional rigidity: %6.2f k.in^2/rad \n',1000*pi*R^4/2)
...
xlabel('X (in)')
ylabel('Y (in)')
zlabel('Shear Stress resultant (ksi)')
set(gca,'FontSize',20)
set(gcf,'color','w')
set(gcf,'unit','inches')
grid on
