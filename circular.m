...
fprintf('Angle of twist per unit length: %6.2f rad/m \n',theta)
fprintf('                  Total torque: %6.2f N.m \n',T)
fprintf('  Numerical Torsional rigidity: %6.2f N.m^2/rad \n',T/theta)
fprintf('____________________________________________________ \n')
fprintf(' Analytical Torsional rigidity: %6.2f N.m^2/rad \n',10*10^6*pi*R^4/2)
